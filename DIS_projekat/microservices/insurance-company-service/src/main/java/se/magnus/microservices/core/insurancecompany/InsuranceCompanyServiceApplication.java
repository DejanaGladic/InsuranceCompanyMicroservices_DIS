...
public class InsuranceCompanyServiceApplication {
	...
	private static final Logger LOG = LoggerFactory.getLogger(InsuranceCompanyServiceApplication.class);
	
	public static void main(String[] args) {
		ConfigurableApplicationContext ctx = SpringApplication.run(InsuranceCompanyServiceApplication.class, args);
